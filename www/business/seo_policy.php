...
<div class="container">
    ...
    <p class="clear_B">HYPER AMBITIONでは、SEOの内部施策のコンサルティングから実際の作業手伝いまでします。どのキーワードを狙っていくかという中長期的な事業展開に関わるビジネスロジックから入り、サイトに載せるページやコンテンツをテーマごとに分け、Googleのクローラボットがサイトのテーマ性を認識しやすくするコンサルティングをします。またタイトル、h1などの見出しの改善はもちろん、ヘッダーやフッター、サブメニュー（サブナビ）の内部リンク適正化などにより、リスクなく質の高いSEO内部施策のアドバイスを行います。</p>

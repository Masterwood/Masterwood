...
<section>
<div class="container">
	<h1>【ランディングページ（LP）制作】WEBならHYPERAMBITION</h1>
	<div class="txt_C">
		<img src="../img/second/business/sales2.jpg" alt="WEB制作のコーチング">
	</div>
	<h2 class="mb_30 font_B">ランディングページ（LP）の制作を代行します</h2>
	...
	<h2 class="mt_50 mb_30 font_B">モノだけではなくヒトの売り込みもできます</h2>
	...
	<h2 class="mt_50 mb_30 font_B">A/Bテストを繰り返して見つけたコンバージョンにつながるデザイン</h2>
